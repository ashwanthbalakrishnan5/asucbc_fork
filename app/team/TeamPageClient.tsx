                  ...
                  <motion.div key={contrib.url} variants={cardVariants}>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="w-16 h-16 rounded-full bg-[var(--theme-card-bg)]/50 border border-[var(--theme-card-border)] mb-3 overflow-hidden relative">
                          <div className="absolute inset-0 bg-linear-to-tl from-[var(--theme-bg)]/20 via-[var(--theme-card-bg)]/10 to-[var(--theme-bg)]/5"></div>
                          <img
                            src={contrib.image}
                            alt={contrib.name}
